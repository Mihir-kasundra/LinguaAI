    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if($username && $email) {
            try {
                ...
                header('Location: admin.php?msg=User+Account+Updated#users');
                exit;
...
<div class="edit-container">
    ...
    <form method="POST">
        <div class="fg">
            <label>UserID</label>
            <input type="text" value="#<?= $u['id'] ?>" disabled style="background:#f8fafc; color:#94a3b8; cursor:not-allowed;">
        </div>
        <div class="fg">
        ...
        <div class="fg">
            <label>Change Password <span style="font-size:0.75rem;color:var(--muted);text-transform:none;font-weight:400;">(Leave blank to keep current)</span></label>
