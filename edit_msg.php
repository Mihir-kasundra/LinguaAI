...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        header('Location: admin.php?msg=Message+Updated#messages');
        exit;
    }
...
<head>
    ...
    <title>Edit Message - Admin</title>
...
<div class="nav-bar">
    ...
    <a href="admin.php#messages" class="back-link">&larr; Back to Dashboard</a>
</div>
...
<div class="edit-container">
    ...
    <form method="POST">
        ...
        <div class="fg">
            <label>Message</label>
            <textarea name="message" rows="6" required><?= htmlspecialchars($msg['message']) ?></textarea>
        </div>
